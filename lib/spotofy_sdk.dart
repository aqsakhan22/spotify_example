...
class SpotofySdk extends StatefulWidget {
  const SpotofySdk({Key? key}) : super(key: key);

  @override
  _SpotofySdkState createState() => _SpotofySdkState();
}

class _SpotofySdkState extends State<SpotofySdk> {
      ...
      child: Column(
        ...
        children: [
          Row(
            ...
            children: <Widget>[
              IconButton(onPressed: queue, icon: Icon(Icons.queue_music)),
              IconButton(onPressed: play, icon: Icon(Icons.playlist_play)),
              IconButton(onPressed: toggleRepeat, icon: Icon(Icons.repeat)),
              IconButton(onPressed: toggleShuffle, icon: Icon(Icons.shuffle)),
          ...
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceEvenly,
            children: [
              IconButton(onPressed: addToLibrary, icon: Icon(Icons.favorite)),
              IconButton(onPressed: () => checkIfAppIsActive(context), icon: Icon(Icons.info)),
        ...
        return Column(
          ...
          children: <Widget>[
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceEvenly,
              children: <Widget>[
                IconButton(onPressed: skipPrevious, icon: Icon(Icons.skip_previous)),
